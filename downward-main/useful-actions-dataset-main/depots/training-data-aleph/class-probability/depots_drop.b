...
:- set(dependent,6). % second arg of class is to predicted
...
:- modeh(1, class(+'type:hoist', +'type:crate', +'type:surface', +'type:place', +task_id, -class)).

%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% determinations:
:- determination(class/6, 'ini:at'/3).
:- determination(class/6, 'goal:at'/3).
:- determination(class/6, 'ini:on'/3).
:- determination(class/6, 'goal:on'/3).
:- determination(class/6, 'ini:in'/3).
:- determination(class/6, 'goal:in'/3).
:- determination(class/6, 'ini:lifting'/3).
:- determination(class/6, 'goal:lifting'/3).
:- determination(class/6, 'ini:available'/2).
:- determination(class/6, 'goal:available'/2).
:- determination(class/6, 'ini:clear'/2).
:- determination(class/6, 'goal:clear'/2).
