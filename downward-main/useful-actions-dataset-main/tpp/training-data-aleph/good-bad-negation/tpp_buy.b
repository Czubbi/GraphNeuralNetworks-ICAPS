...
:- modeh(1, class(+'type:truck', +'type:goods', +'type:market', +'type:level', +'type:level', +'type:level', +'type:level', +task_id)).

%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% determinations:
:- determination(class/8, 'ini:loaded'/4).
:- determination(class/8, 'goal:loaded'/4).
:- determination(class/8, 'ini:not:loaded'/4).
:- determination(class/8, 'goal:not:loaded'/4).
:- determination(class/8, 'ini:ready-to-load'/4).
:- determination(class/8, 'goal:ready-to-load'/4).
:- determination(class/8, 'ini:not:ready-to-load'/4).
:- determination(class/8, 'goal:not:ready-to-load'/4).
:- determination(class/8, 'ini:stored'/3).
:- determination(class/8, 'goal:stored'/3).
:- determination(class/8, 'ini:not:stored'/3).
:- determination(class/8, 'goal:not:stored'/3).
:- determination(class/8, 'ini:on-sale'/4).
:- determination(class/8, 'goal:on-sale'/4).
:- determination(class/8, 'ini:not:on-sale'/4).
:- determination(class/8, 'goal:not:on-sale'/4).
:- determination(class/8, 'ini:next'/3).
:- determination(class/8, 'goal:next'/3).
:- determination(class/8, 'ini:not:next'/3).
:- determination(class/8, 'goal:not:next'/3).
:- determination(class/8, 'ini:at'/3).
:- determination(class/8, 'goal:at'/3).
:- determination(class/8, 'ini:not:at'/3).
:- determination(class/8, 'goal:not:at'/3).
:- determination(class/8, 'ini:connected'/3).
:- determination(class/8, 'goal:connected'/3).
:- determination(class/8, 'ini:not:connected'/3).
:- determination(class/8, 'goal:not:connected'/3).
:- determination(class/8, equals/3).
