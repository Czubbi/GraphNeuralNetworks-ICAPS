...
:- set(dependent,5). % second arg of class is to predicted
...
:- modeh(1, class(+'type:truck', +'type:place', +'type:place', +task_id, -class)).

%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% determinations:
:- determination(class/5, 'ini:loaded'/4).
:- determination(class/5, 'goal:loaded'/4).
:- determination(class/5, 'ini:not:loaded'/4).
:- determination(class/5, 'goal:not:loaded'/4).
:- determination(class/5, 'ini:ready-to-load'/4).
:- determination(class/5, 'goal:ready-to-load'/4).
:- determination(class/5, 'ini:not:ready-to-load'/4).
:- determination(class/5, 'goal:not:ready-to-load'/4).
:- determination(class/5, 'ini:stored'/3).
:- determination(class/5, 'goal:stored'/3).
:- determination(class/5, 'ini:not:stored'/3).
:- determination(class/5, 'goal:not:stored'/3).
:- determination(class/5, 'ini:on-sale'/4).
:- determination(class/5, 'goal:on-sale'/4).
:- determination(class/5, 'ini:not:on-sale'/4).
:- determination(class/5, 'goal:not:on-sale'/4).
:- determination(class/5, 'ini:next'/3).
:- determination(class/5, 'goal:next'/3).
:- determination(class/5, 'ini:not:next'/3).
:- determination(class/5, 'goal:not:next'/3).
:- determination(class/5, 'ini:at'/3).
:- determination(class/5, 'goal:at'/3).
:- determination(class/5, 'ini:not:at'/3).
:- determination(class/5, 'goal:not:at'/3).
:- determination(class/5, 'ini:connected'/3).
:- determination(class/5, 'goal:connected'/3).
:- determination(class/5, 'ini:not:connected'/3).
:- determination(class/5, 'goal:not:connected'/3).
:- determination(class/5, equals/3).
