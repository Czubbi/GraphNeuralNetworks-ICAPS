...
:- modeh(1, class(+'type:truck', +'type:goods', +'type:market', +'type:level', +'type:level', +'type:level', +'type:level', +task_id, -class)).

%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% determinations:
:- determination(class/9, 'ini:loaded'/4).
:- determination(class/9, 'goal:loaded'/4).
:- determination(class/9, 'ini:not:loaded'/4).
:- determination(class/9, 'goal:not:loaded'/4).
:- determination(class/9, 'ini:ready-to-load'/4).
:- determination(class/9, 'goal:ready-to-load'/4).
:- determination(class/9, 'ini:not:ready-to-load'/4).
:- determination(class/9, 'goal:not:ready-to-load'/4).
:- determination(class/9, 'ini:stored'/3).
:- determination(class/9, 'goal:stored'/3).
:- determination(class/9, 'ini:not:stored'/3).
:- determination(class/9, 'goal:not:stored'/3).
:- determination(class/9, 'ini:on-sale'/4).
:- determination(class/9, 'goal:on-sale'/4).
:- determination(class/9, 'ini:not:on-sale'/4).
:- determination(class/9, 'goal:not:on-sale'/4).
:- determination(class/9, 'ini:next'/3).
:- determination(class/9, 'goal:next'/3).
:- determination(class/9, 'ini:not:next'/3).
:- determination(class/9, 'goal:not:next'/3).
:- determination(class/9, 'ini:at'/3).
:- determination(class/9, 'goal:at'/3).
:- determination(class/9, 'ini:not:at'/3).
:- determination(class/9, 'goal:not:at'/3).
:- determination(class/9, 'ini:connected'/3).
:- determination(class/9, 'goal:connected'/3).
:- determination(class/9, 'ini:not:connected'/3).
:- determination(class/9, 'goal:not:connected'/3).
:- determination(class/9, equals/3).
