(define (problem prob_agricola)
 (:domain agricola)
 (:objects 
num1 num2 num3 num4 num5 num6 num7 num8 num9 num10 num11 num12 num13 num14 num15 num16 num17 num18 num19 num20 num21 num22 num23 num24 num25 num26 num27 num28 num29 num30 num31 num32 - num 
stage1 stage2 stage3 stage4 stage5 stage6 stage7 stage8 stage9 stage10 stage11 stage12 stage13 stage14 stage15 stage16 - stage
round1 round2 round3 round4 round5 round6 round7 round8 round9 round10 round11 round12 round13 round14 round15 round16 round17 round18 round19 round20 round21 round22 round23 round24 round25 round26 round27 round28 - round 
worker1 worker2 worker3 worker4 worker5 worker6 worker7 worker8 worker9 worker10 worker11 worker12 worker13 worker14 worker15 - worker 
room1 room2 room3 room4 room5 room6 room7 room8 room9 room10 room11 room12 room13 room14 room15 - room 
 ...
 (:init 
    ...
    (NEXT_NUM num28 num29)
    (NEXT_NUM num29 num30)
    (NEXT_NUM num30 num31)
    (NEXT_NUM num31 num32)
    ...
    (NUM_SUBSTRACT num29 num1 num28)
    (NUM_SUBSTRACT num29 num2 num27)
    (NUM_SUBSTRACT num29 num3 num26)
    (NUM_SUBSTRACT num29 num4 num25)
    (NUM_SUBSTRACT num29 num5 num24)
    (NUM_SUBSTRACT num29 num6 num23)
    (NUM_SUBSTRACT num29 num7 num22)
    (NUM_SUBSTRACT num29 num8 num21)
    (NUM_SUBSTRACT num29 num9 num20)
    (NUM_SUBSTRACT num29 num10 num19)
    (NUM_SUBSTRACT num29 num11 num18)
    (NUM_SUBSTRACT num29 num12 num17)
    (NUM_SUBSTRACT num29 num13 num16)
    (NUM_SUBSTRACT num29 num14 num15)
    (NUM_SUBSTRACT num29 num15 num14)
    (NUM_SUBSTRACT num29 num16 num13)
    (NUM_SUBSTRACT num29 num17 num12)
    (NUM_SUBSTRACT num29 num18 num11)
    (NUM_SUBSTRACT num29 num19 num10)
    (NUM_SUBSTRACT num29 num20 num9)
    (NUM_SUBSTRACT num29 num21 num8)
    (NUM_SUBSTRACT num29 num22 num7)
    (NUM_SUBSTRACT num29 num23 num6)
    (NUM_SUBSTRACT num29 num24 num5)
    (NUM_SUBSTRACT num29 num25 num4)
    (NUM_SUBSTRACT num29 num26 num3)
    (NUM_SUBSTRACT num29 num27 num2)
    (NUM_SUBSTRACT num29 num28 num1)
    (NUM_SUBSTRACT num29 num29 num0)
    (NUM_SUBSTRACT num30 num1 num29)
    (NUM_SUBSTRACT num30 num2 num28)
    (NUM_SUBSTRACT num30 num3 num27)
    (NUM_SUBSTRACT num30 num4 num26)
    (NUM_SUBSTRACT num30 num5 num25)
    (NUM_SUBSTRACT num30 num6 num24)
    (NUM_SUBSTRACT num30 num7 num23)
    (NUM_SUBSTRACT num30 num8 num22)
    (NUM_SUBSTRACT num30 num9 num21)
    (NUM_SUBSTRACT num30 num10 num20)
    (NUM_SUBSTRACT num30 num11 num19)
    (NUM_SUBSTRACT num30 num12 num18)
    (NUM_SUBSTRACT num30 num13 num17)
    (NUM_SUBSTRACT num30 num14 num16)
    (NUM_SUBSTRACT num30 num15 num15)
    (NUM_SUBSTRACT num30 num16 num14)
    (NUM_SUBSTRACT num30 num17 num13)
    (NUM_SUBSTRACT num30 num18 num12)
    (NUM_SUBSTRACT num30 num19 num11)
    (NUM_SUBSTRACT num30 num20 num10)
    (NUM_SUBSTRACT num30 num21 num9)
    (NUM_SUBSTRACT num30 num22 num8)
    (NUM_SUBSTRACT num30 num23 num7)
    (NUM_SUBSTRACT num30 num24 num6)
    (NUM_SUBSTRACT num30 num25 num5)
    (NUM_SUBSTRACT num30 num26 num4)
    (NUM_SUBSTRACT num30 num27 num3)
    (NUM_SUBSTRACT num30 num28 num2)
    (NUM_SUBSTRACT num30 num29 num1)
    (NUM_SUBSTRACT num30 num30 num0)
    (NUM_SUBSTRACT num31 num1 num30)
    (NUM_SUBSTRACT num31 num2 num29)
    (NUM_SUBSTRACT num31 num3 num28)
    (NUM_SUBSTRACT num31 num4 num27)
    (NUM_SUBSTRACT num31 num5 num26)
    (NUM_SUBSTRACT num31 num6 num25)
    (NUM_SUBSTRACT num31 num7 num24)
    (NUM_SUBSTRACT num31 num8 num23)
    (NUM_SUBSTRACT num31 num9 num22)
    (NUM_SUBSTRACT num31 num10 num21)
    (NUM_SUBSTRACT num31 num11 num20)
    (NUM_SUBSTRACT num31 num12 num19)
    (NUM_SUBSTRACT num31 num13 num18)
    (NUM_SUBSTRACT num31 num14 num17)
    (NUM_SUBSTRACT num31 num15 num16)
    (NUM_SUBSTRACT num31 num16 num15)
    (NUM_SUBSTRACT num31 num17 num14)
    (NUM_SUBSTRACT num31 num18 num13)
    (NUM_SUBSTRACT num31 num19 num12)
    (NUM_SUBSTRACT num31 num20 num11)
    (NUM_SUBSTRACT num31 num21 num10)
    (NUM_SUBSTRACT num31 num22 num9)
    (NUM_SUBSTRACT num31 num23 num8)
    (NUM_SUBSTRACT num31 num24 num7)
    (NUM_SUBSTRACT num31 num25 num6)
    (NUM_SUBSTRACT num31 num26 num5)
    (NUM_SUBSTRACT num31 num27 num4)
    (NUM_SUBSTRACT num31 num28 num3)
    (NUM_SUBSTRACT num31 num29 num2)
    (NUM_SUBSTRACT num31 num30 num1)
    (NUM_SUBSTRACT num31 num31 num0)
    (NUM_SUBSTRACT num32 num1 num31)
    (NUM_SUBSTRACT num32 num2 num30)
    (NUM_SUBSTRACT num32 num3 num29)
    (NUM_SUBSTRACT num32 num4 num28)
    (NUM_SUBSTRACT num32 num5 num27)
    (NUM_SUBSTRACT num32 num6 num26)
    (NUM_SUBSTRACT num32 num7 num25)
    (NUM_SUBSTRACT num32 num8 num24)
    (NUM_SUBSTRACT num32 num9 num23)
    (NUM_SUBSTRACT num32 num10 num22)
    (NUM_SUBSTRACT num32 num11 num21)
    (NUM_SUBSTRACT num32 num12 num20)
    (NUM_SUBSTRACT num32 num13 num19)
    (NUM_SUBSTRACT num32 num14 num18)
    (NUM_SUBSTRACT num32 num15 num17)
    (NUM_SUBSTRACT num32 num16 num16)
    (NUM_SUBSTRACT num32 num17 num15)
    (NUM_SUBSTRACT num32 num18 num14)
    (NUM_SUBSTRACT num32 num19 num13)
    (NUM_SUBSTRACT num32 num20 num12)
    (NUM_SUBSTRACT num32 num21 num11)
    (NUM_SUBSTRACT num32 num22 num10)
    (NUM_SUBSTRACT num32 num23 num9)
    (NUM_SUBSTRACT num32 num24 num8)
    (NUM_SUBSTRACT num32 num25 num7)
    (NUM_SUBSTRACT num32 num26 num6)
    (NUM_SUBSTRACT num32 num27 num5)
    (NUM_SUBSTRACT num32 num28 num4)
    (NUM_SUBSTRACT num32 num29 num3)
    (NUM_SUBSTRACT num32 num30 num2)
    (NUM_SUBSTRACT num32 num31 num1)
    (NUM_SUBSTRACT num32 num32 num0)
    (NEXT2_NUM num0 num2)
    (NEXT2_NUM num1 num3)
    (NEXT2_NUM num2 num4)
    (NEXT2_NUM num3 num5)
    ...
    (NEXT2_NUM num27 num29)
    (NEXT2_NUM num28 num30)
    (NEXT2_NUM num29 num31)
    (NEXT2_NUM num30 num32)
    ...
    (NEXT_STAGE stage13 stage14)
    (NEXT_STAGE stage14 stage15)
    (NEXT_STAGE stage15 stage16)
    ...
    (NEXT_ROUND round21 round22)
    (NEXT_ROUND round22 round23)
    (NEXT_ROUND round23 round24)
    (NEXT_ROUND round24 round25)
    (NEXT_ROUND round25 round26)
    (NEXT_ROUND round26 round27)
    (NEXT_ROUND round27 round28)
    (NEXT_WORKER worker15 worker14)
    (NEXT_WORKER worker14 worker13)
    ...
    (category_round round14 tnormal)
    (category_round round15 tharvest)
    (category_round round16 tnormal)
    (category_round round17 tharvest)
    (category_round round18 tnormal)
    (category_round round19 tharvest)
    (category_round round20 tnormal)
    (category_round round21 tharvest)
    (category_round round22 tharvest)
    (category_round round23 tharvest)
    (category_round round24 tharvest)
    (category_round round25 tharvest)
    (category_round round26 tharvest)
    (category_round round27 tharvest)
    (category_round round28 tharvest)
    ...
    (DRAWCARD_ROUND void round22)
    (DRAWCARD_ROUND void round23)
    (DRAWCARD_ROUND void round24)
    (DRAWCARD_ROUND void round25)
    (DRAWCARD_ROUND void round26)
    (DRAWCARD_ROUND void round27)
    (DRAWCARD_ROUND void round28)
    ...
    (FOOD_REQUIRED worker14 num28)
    (FOOD_REQUIRED worker14 num29)
    (FOOD_REQUIRED worker15 num30)
    (FOOD_REQUIRED worker15 num31)
    ...
    (space_rooms room14)
    (space_rooms room15)
    (= (group_worker_cost worker2) 330)
    (= (group_worker_cost worker3) 300)
    (= (group_worker_cost worker4) 270)
    (= (group_worker_cost worker5) 240)
    (= (group_worker_cost worker6) 210)
    (= (group_worker_cost worker7) 180)
    (= (group_worker_cost worker8) 150)
    (= (group_worker_cost worker9) 120)
    (= (group_worker_cost worker10) 90)
    (= (group_worker_cost worker11) 60)
    (= (group_worker_cost worker12) 30)
    (= (group_worker_cost worker13) 15)
    (= (group_worker_cost worker14) 6)
    (= (group_worker_cost worker15) 4))
 (:goal (and 
    (harvest_phase stage15 harvest_end)))
