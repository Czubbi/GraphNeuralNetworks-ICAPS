...
; This has 17 hosts, 2 user, 2 admin per host, 2 active account per host
(define (problem p17_hosts_trial_2)
(:domain caldera)
(:objects id_fgFile id_fiFile id_fcFile id_fdFile id_fbFile id_fhFile id_flFile id_fnFile id_fmFile id_foFile id_feFile id_fjFile id_fkFile id_fqFile id_frFile id_fpFile id_ffFile - ObservedFile 
 id_btHost id_cvHost id_caHost id_coHost id_dcHost id_bfHost id_eeHost id_elHost id_djHost id_dqHost id_kHost id_rHost id_dxHost id_bmHost id_chHost id_yHost id_esHost - ObservedHost 
 num__83 num__20 num__33 num__13 num__90 num__69 num__118 num__47 num__48 num__26 num__110 num__124 num__40 num__117 num__89 num__41 num__34 num__111 num__125 num__96 num__54 num__82 num__68 num__12 num__55 num__76 num__61 num__97 num__103 num__104 num__19 num__62 num__27 num__75 - num 
 id_ciTimeDelta id_zTimeDelta id_drTimeDelta id_efTimeDelta id_cpTimeDelta id_cbTimeDelta id_emTimeDelta id_bnTimeDelta id_dkTimeDelta id_dyTimeDelta id_lTimeDelta id_bgTimeDelta id_sTimeDelta id_etTimeDelta id_ddTimeDelta id_buTimeDelta id_cwTimeDelta - ObservedTimeDelta 
 id_cDomainUser id_gDomainUser - ObservedDomainUser 
 id_grSchtask id_guSchtask id_gqSchtask id_gvSchtask id_goSchtask id_gtSchtask id_gxSchtask id_gnSchtask id_gmSchtask id_gjSchtask id_glSchtask id_gySchtask id_gzSchtask id_gkSchtask id_gsSchtask id_gpSchtask id_gwSchtask - ObservedSchtask 
 id_hhShare id_hkShare id_hcShare id_hbShare id_haShare id_hpShare id_hmShare id_hoShare id_hqShare id_hgShare id_hdShare id_hiShare id_heShare id_hlShare id_hfShare id_hnShare id_hjShare - ObservedShare 
 id_aDomain - ObservedDomain 
 id_fxRat id_geRat id_fzRat id_fvRat id_ftRat id_gbRat id_giRat id_fsRat id_gfRat id_ggRat id_gcRat id_gaRat id_ghRat id_gdRat id_fwRat id_fyRat id_fuRat id_ezRat - ObservedRat 
 id_dDomainCredential id_hDomainCredential - ObservedDomainCredential 
 str__dn str__ce str__cf str__i str__ek str__dg str__br str__fa str__x str__q str__bj str__da str__eb str__ew str__bx str__ey str__do str__du str__ep str__v str__er str__bl str__dw str__o str__bk str__bz str__eq str__w str__dp str__mary str__dv str__ei str__cu str__bc str__cg str__p str__bq str__ed str__alpha str__cl str__by str__j str__bs str__f str__ej str__ex str__be str__b str__dh str__e str__cs str__ct str__di str__db str__ec str__bd str__james str__cm str__cz str__cn - string 
)
...
(:goal   (and 
     ...
     (prop_host id_geRat id_btHost)
     (prop_host id_gbRat id_caHost)
     (prop_host id_giRat id_dqHost)
     (prop_host id_ggRat id_rHost)
     (prop_host id_gcRat id_elHost)
     (prop_host id_ghRat id_yHost)
     (prop_host id_gfRat id_cvHost)
     (prop_host id_fxRat id_dcHost)
     (prop_host id_fzRat id_coHost)
     (prop_host id_fvRat id_eeHost)
     (prop_host id_ftRat id_bfHost)
     (prop_host id_fsRat id_kHost)
     (prop_host id_gaRat id_dxHost)
     (prop_host id_gdRat id_bmHost)
     (prop_host id_fwRat id_chHost)
)
)
)