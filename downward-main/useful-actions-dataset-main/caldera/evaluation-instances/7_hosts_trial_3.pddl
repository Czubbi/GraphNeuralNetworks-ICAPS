...
; This has 7 hosts, 4 user, 2 admin per host, 2 active account per host
(define (problem p7_hosts_trial_3)
(:domain caldera)
(:objects id_crSchtask id_cuSchtask id_cvSchtask id_cxSchtask id_cwSchtask id_ctSchtask id_csSchtask - ObservedSchtask 
 id_sHost id_bgHost id_zHost id_cbHost id_ciHost id_bnHost id_buHost - ObservedHost 
 num__28 num__21 num__42 num__48 num__49 num__56 num__62 num__35 num__63 num__41 num__20 num__27 num__55 num__34 - num 
 str__james str__x str__cg str__bm str__bl str__by str__be str__bk str__bz str__r str__john str__cn str__bf str__cq str__m str__w str__i str__cm str__alpha str__co str__bt str__e str__n str__ch str__patricia str__q str__b str__cf str__y str__bd str__ca str__j str__bs str__f str__br str__mary - string 
 id_hDomainCredential id_lDomainCredential id_pDomainCredential id_dDomainCredential - ObservedDomainCredential 
 id_bhTimeDelta id_ccTimeDelta id_tTimeDelta id_boTimeDelta id_cjTimeDelta id_baTimeDelta id_bvTimeDelta - ObservedTimeDelta 
 id_deRat id_dbRat id_czRat id_dcRat id_ddRat id_daRat id_cyRat id_cpRat - ObservedRat 
 id_dsFile id_dnFile id_dpFile id_dmFile id_dqFile id_drFile id_doFile - ObservedFile 
 id_aDomain - ObservedDomain 
 id_diShare id_dfShare id_dkShare id_djShare id_dgShare id_dhShare id_dlShare - ObservedShare 
 id_kDomainUser id_cDomainUser id_gDomainUser id_oDomainUser - ObservedDomainUser 
)
(:init     (knows id_cpRat)
     (knows id_sHost)
...
(:goal   (and 
     (prop_host id_cyRat id_buHost)
     (prop_host id_deRat id_bgHost)
     (prop_host id_dbRat id_zHost)
     (prop_host id_czRat id_cbHost)
     (prop_host id_dcRat id_ciHost)
     (prop_host id_ddRat id_bnHost)
)
)
)