...
; This has 20 hosts, 4 user, 2 admin per host, 2 active account per host
(define (problem p20_hosts_trial_3)
(:domain caldera)
(:objects id_cDomainUser id_kDomainUser id_gDomainUser id_oDomainUser - ObservedDomainUser 
 id_goRat id_gcRat id_geRat id_ggRat id_gmRat id_gqRat id_gvRat id_gkRat id_gwRat id_grRat id_gsRat id_gxRat id_gjRat id_gpRat id_giRat id_ghRat id_glRat id_gfRat id_gnRat id_guRat id_gtRat - ObservedRat 
 str__ff str__fe str__fm str__ec str__x str__dc str__fu str__q str__fs str__bl str__ga str__by str__cu str__bz str__e str__br str__patricia str__i str__m str__bk str__ed str__gb str__da str__do str__dv str__ee str__n str__cg str__db str__di str__y str__el str__ez str__b str__w str__bm str__alpha str__dx str__j str__cf str__r str__eq str__ex str__cm str__ca str__james str__mary str__john str__bs str__bf str__dh str__dw str__bt str__dp str__er str__gd str__fl str__bd str__cn str__be str__es str__ey str__ft str__dq str__cv str__fg str__ch str__ek str__co str__ej str__ct str__f str__fn str__dj str__fz - string 
 id_pDomainCredential id_hDomainCredential id_dDomainCredential id_lDomainCredential - ObservedDomainCredential 
 id_aDomain - ObservedDomain 
 id_efHost id_cpHost id_cbHost id_ciHost id_dkHost id_emHost id_zHost id_ddHost id_drHost id_fhHost id_etHost id_faHost id_bnHost id_bgHost id_sHost id_cwHost id_buHost id_foHost id_dyHost id_fvHost - ObservedHost 
 id_ipFile id_iyFile id_jbFile id_iqFile id_jaFile id_izFile id_jeFile id_jfFile id_ivFile id_isFile id_itFile id_iuFile id_ixFile id_iwFile id_ioFile id_jcFile id_jdFile id_imFile id_inFile id_irFile - ObservedFile 
 id_hnShare id_hkShare id_hrShare id_hmShare id_haShare id_hcShare id_heShare id_hpShare id_gyShare id_hdShare id_hfShare id_hgShare id_hqShare id_hhShare id_hiShare id_gzShare id_hlShare id_hjShare id_hoShare id_hbShare - ObservedShare 
 id_fpTimeDelta id_dzTimeDelta id_ccTimeDelta id_tTimeDelta id_enTimeDelta id_cqTimeDelta id_baTimeDelta id_dsTimeDelta id_fwTimeDelta id_egTimeDelta id_fbTimeDelta id_bhTimeDelta id_deTimeDelta id_dlTimeDelta id_cxTimeDelta id_cjTimeDelta id_boTimeDelta id_fiTimeDelta id_bvTimeDelta id_euTimeDelta - ObservedTimeDelta 
 id_ilSchtask id_hvSchtask id_huSchtask id_iiSchtask id_iaSchtask id_ifSchtask id_ijSchtask id_hsSchtask id_icSchtask id_hwSchtask id_idSchtask id_ieSchtask id_ibSchtask id_igSchtask id_ihSchtask id_ikSchtask id_htSchtask id_hxSchtask id_hzSchtask id_hySchtask - ObservedSchtask 
 num__28 num__49 num__56 num__20 num__77 num__41 num__91 num__147 num__21 num__105 num__154 num__83 num__132 num__97 num__146 num__69 num__55 num__76 num__70 num__104 num__84 num__112 num__111 num__119 num__133 num__153 num__125 num__48 num__140 num__98 num__118 num__90 num__35 num__62 num__34 num__139 num__42 num__126 num__63 num__27 - num 
)
(:init     (knows id_gcRat)
     (knows id_sHost)
...
(:goal   (and 
     ...
     (prop_host id_goRat id_ciHost)
     (prop_host id_gvRat id_dkHost)
     (prop_host id_gmRat id_etHost)
     (prop_host id_gqRat id_cwHost)
     (prop_host id_gwRat id_buHost)
     (prop_host id_gsRat id_foHost)
     (prop_host id_giRat id_dyHost)
     (prop_host id_ghRat id_fvHost)
     (prop_host id_glRat id_efHost)
     (prop_host id_gfRat id_cpHost)
     (prop_host id_gnRat id_cbHost)
     (prop_host id_geRat id_emHost)
     (prop_host id_ggRat id_fhHost)
     (prop_host id_gxRat id_zHost)
     (prop_host id_gkRat id_ddHost)
     (prop_host id_grRat id_drHost)
     (prop_host id_gjRat id_faHost)
