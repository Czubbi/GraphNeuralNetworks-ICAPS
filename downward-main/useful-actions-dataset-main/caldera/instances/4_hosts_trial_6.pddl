...
; This has 4 hosts, 2 user, 1 admin per host, 1 active account per host
(define (problem p4_hosts_trial_6)
(:domain caldera)
(:objects str__o str__q str__bj str__be str__v str__b str__mary str__james str__bd str__i str__w str__e str__j str__bl str__alpha str__bn str__bc str__x str__f str__bk str__p - string 
 id_bzRat id_bmRat id_bwRat id_bxRat id_byRat - ObservedRat 
 num__34 num__26 num__20 num__19 num__12 num__33 num__13 num__27 - num 
 id_gDomainUser id_cDomainUser - ObservedDomainUser 
 id_dDomainCredential id_hDomainCredential - ObservedDomainCredential 
 id_brFile id_bpFile id_bqFile id_boFile - ObservedFile 
 id_sTimeDelta id_bgTimeDelta id_zTimeDelta id_lTimeDelta - ObservedTimeDelta 
 id_rHost id_yHost id_bfHost id_kHost - ObservedHost 
 id_buShare id_btShare id_bsShare id_bvShare - ObservedShare 
 id_caSchtask id_cbSchtask id_ccSchtask id_cdSchtask - ObservedSchtask 
...
(:goal   (and 
     (prop_host id_byRat id_kHost)
     (prop_host id_bzRat id_rHost)
     (prop_host id_bwRat id_yHost)
)
)
)