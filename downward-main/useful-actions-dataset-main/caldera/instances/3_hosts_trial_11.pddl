...
; This has 3 hosts, 6 user, 3 admin per host, 3 active account per host
(define (problem p3_hosts_trial_11)
(:domain caldera)
(:objects id_biTimeDelta id_bbTimeDelta id_bpTimeDelta - ObservedTimeDelta 
 num__42 num__35 num__29 num__28 num__43 num__36 - num 
 id_ceRat id_cdRat id_bvRat id_cfRat - ObservedRat 
 id_bhHost id_boHost id_baHost - ObservedHost 
 id_xDomainCredential id_pDomainCredential id_lDomainCredential id_tDomainCredential id_hDomainCredential id_dDomainCredential - ObservedDomainCredential 
 id_ccSchtask id_caSchtask id_cbSchtask - ObservedSchtask 
 id_bzShare id_bxShare id_byShare - ObservedShare 
 id_chFile id_ciFile id_cgFile - ObservedFile 
 id_wDomainUser id_kDomainUser id_sDomainUser id_gDomainUser id_cDomainUser id_oDomainUser - ObservedDomainUser 
 id_aDomain - ObservedDomain 
 str__n str__m str__linda str__y str__e str__bu str__john str__patricia str__bt str__v str__bf str__bs str__alpha str__q str__bm str__j str__be str__u str__bl str__robert str__bn str__i str__bw str__james str__z str__b str__f str__bg str__mary str__r - string 
)
