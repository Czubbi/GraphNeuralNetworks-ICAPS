...
; This has 2 hosts, 28 user, 2 admin per host, 5 active account per host
(define (problem p2_hosts_trial_7)
(:domain caldera)
(:objects id_elTimeDelta id_esTimeDelta - ObservedTimeDelta 
 id_ccDomainUser id_ecDomainUser id_bqDomainUser id_kDomainUser id_diDomainUser id_csDomainUser id_sDomainUser id_dyDomainUser id_byDomainUser id_cgDomainUser id_buDomainUser id_cDomainUser id_beDomainUser id_coDomainUser id_ckDomainUser id_baDomainUser id_deDomainUser id_dmDomainUser id_gDomainUser id_bmDomainUser id_oDomainUser id_dqDomainUser id_biDomainUser id_duDomainUser id_egDomainUser id_wDomainUser id_daDomainUser id_cwDomainUser - ObservedDomainUser 
 id_chDomainCredential id_dvDomainCredential id_bvDomainCredential id_dzDomainCredential id_xDomainCredential id_bjDomainCredential id_edDomainCredential id_dfDomainCredential id_pDomainCredential id_drDomainCredential id_dnDomainCredential id_tDomainCredential id_ehDomainCredential id_dDomainCredential id_cdDomainCredential id_brDomainCredential id_ctDomainCredential id_bbDomainCredential id_hDomainCredential id_bfDomainCredential id_dbDomainCredential id_lDomainCredential id_bzDomainCredential id_cpDomainCredential id_bnDomainCredential id_clDomainCredential id_djDomainCredential id_cxDomainCredential - ObservedDomainCredential 
 id_fdFile id_fcFile - ObservedFile 
 id_ffShare id_feShare - ObservedShare 
 num__123 num__124 num__116 num__117 - num 
 id_ekHost id_erHost - ObservedHost 
 id_aDomain - ObservedDomain 
 id_fgSchtask id_fhSchtask - ObservedSchtask 
 id_eyRat id_fbRat id_faRat - ObservedRat 
 str__ee str__mark str__dorothy str__q str__r str__david str__eq str__susan str__i str__bd str__ei str__eb str__william str__charles str__z str__eo str__michael str__nancy str__b str__bx str__daniel str__ef str__james str__bl str__betty str__bp str__john str__mary str__maria str__cz str__dc str__v str__cv str__j str__cm str__ep str__f str__bc str__bs str__ea str__y str__ev str__e str__ew str__cr str__dd str__barbara str__cb str__ca str__n str__ce str__alpha str__bk str__dl str__patricia str__dg str__paul str__jennifer str__ex str__dh str__elizabeth str__margaret str__karen str__ds str__cn str__do str__cu str__m str__dw str__bh str__linda str__bt str__cf str__cq str__dp str__joseph str__ej str__richard str__lisa str__ez str__cj str__dx str__thomas str__bg str__christopher str__robert str__cy str__u str__ci str__bo str__dt str__dk str__bw - string 
)
