...
(define (problem p4_hosts_trial_4)
(:domain caldera)
(:objects id_aDomain - ObservedDomain 
 id_bwShare id_byShare id_bzShare id_bxShare - ObservedShare 
 id_caSchtask id_ccSchtask id_cdSchtask id_cbSchtask - ObservedSchtask 
 id_pDomainCredential id_lDomainCredential id_dDomainCredential id_hDomainCredential - ObservedDomainCredential 
 num__20 num__21 num__27 num__41 num__42 num__35 num__28 num__34 - num 
 id_tTimeDelta id_bhTimeDelta id_boTimeDelta id_baTimeDelta - ObservedTimeDelta 
 id_oDomainUser id_cDomainUser id_kDomainUser id_gDomainUser - ObservedDomainUser 
 id_chFile id_cfFile id_ceFile id_cgFile - ObservedFile 
 id_bgHost id_zHost id_bnHost id_sHost - ObservedHost 
 id_cjRat id_clRat id_buRat id_ciRat id_ckRat - ObservedRat 
 str__m str__w str__bk str__bm str__n str__i str__bv str__r str__john str__f str__b str__bf str__bs str__be str__br str__x str__q str__bl str__james str__bt str__j str__alpha str__bd str__e str__mary str__patricia str__y - string 
)
(:init     (knows id_buRat)
     (knows id_zHost)
...
(:goal   (and 
     (prop_host id_ckRat id_sHost)
     (prop_host id_cjRat id_bgHost)
     (prop_host id_clRat id_bnHost)
)
)
)