...
(define (problem p2_hosts_trial_16)
(:domain caldera)
(:objects id_baTimeDelta id_tTimeDelta - ObservedTimeDelta 
 id_hDomainCredential id_lDomainCredential id_dDomainCredential id_pDomainCredential - ObservedDomainCredential 
 str__r str__alpha str__patricia str__e str__m str__bd str__x str__q str__y str__mary str__bh str__i str__w str__j str__bf str__n str__b str__be str__f str__james str__john - string 
 ...
 id_bjRat id_bgRat id_biRat - ObservedRat 
