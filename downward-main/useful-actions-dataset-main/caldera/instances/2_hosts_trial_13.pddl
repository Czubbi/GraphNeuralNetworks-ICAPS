...
; This has 2 hosts, 4 user, 2 admin per host, 3 active account per host
(define (problem p2_hosts_trial_13)
(:domain caldera)
(:objects id_pDomainCredential id_dDomainCredential id_lDomainCredential id_hDomainCredential - ObservedDomainCredential 
 id_blSchtask id_bkSchtask - ObservedSchtask 
 id_sHost id_zHost - ObservedHost 
 id_aDomain - ObservedDomain 
 id_kDomainUser id_cDomainUser id_gDomainUser id_oDomainUser - ObservedDomainUser 
 num__27 num__21 num__28 num__20 - num 
 str__j str__x str__m str__be str__john str__bd str__e str__bf str__f str__mary str__b str__bh str__patricia str__w str__alpha str__n str__james str__r str__i str__q str__y - string 
 id_bjRat id_biRat id_bgRat - ObservedRat 
 id_bmShare id_bnShare - ObservedShare 
 id_boFile id_bpFile - ObservedFile 
