...
(define (problem p5_hosts_trial_5)
(:domain caldera)
(:objects id_hDomainCredential id_dDomainCredential - ObservedDomainCredential 
 id_kHost id_yHost id_rHost id_bmHost id_bfHost - ObservedHost 
 id_ceShare id_caShare id_cdShare id_ccShare id_cbShare - ObservedShare 
 num__19 num__13 num__40 num__26 num__33 num__34 num__41 num__27 num__20 num__12 - num 
 id_aDomain - ObservedDomain 
 id_bwSchtask id_bxSchtask id_bzSchtask id_bySchtask id_bvSchtask - ObservedSchtask 
 str__bs str__q str__bc str__bk str__james str__bl str__w str__bu str__br str__e str__v str__x str__alpha str__b str__i str__f str__bj str__o str__mary str__bd str__j str__p str__bq str__be - string 
 id_btRat id_cjRat id_cfRat id_ciRat id_chRat id_cgRat - ObservedRat 
 id_cDomainUser id_gDomainUser - ObservedDomainUser 
 id_cmFile id_ckFile id_clFile id_cnFile id_coFile - ObservedFile 
 id_bnTimeDelta id_zTimeDelta id_lTimeDelta id_bgTimeDelta id_sTimeDelta - ObservedTimeDelta 
)
(:init     (knows id_btRat)
     (knows id_rHost)
...
(:goal   (and 
     (prop_host id_cjRat id_bfHost)
     (prop_host id_cfRat id_kHost)
     (prop_host id_chRat id_yHost)
     (prop_host id_ciRat id_bmHost)
)
)
)